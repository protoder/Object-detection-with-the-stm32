...
CC_DEPS += \
./Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/schema_utils.d 

OBJS += \
./Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/schema_utils.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/%.o Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/%.su Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/%.cyclo: ../Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/%.cc Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/subdir.mk
...
clean: clean-Middlewares-2f-tensorflow-2f-tensorflow-2f-compiler-2f-mlir-2f-lite-2f-schema

clean-Middlewares-2f-tensorflow-2f-tensorflow-2f-compiler-2f-mlir-2f-lite-2f-schema:
	-$(RM) ./Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/schema_utils.cyclo ./Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/schema_utils.d ./Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/schema_utils.o ./Middlewares/tensorflow/tensorflow/compiler/mlir/lite/schema/schema_utils.su

.PHONY: clean-Middlewares-2f-tensorflow-2f-tensorflow-2f-compiler-2f-mlir-2f-lite-2f-schema
