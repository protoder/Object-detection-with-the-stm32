...
C_SRCS += \
../08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/kiss_fft.c 

C_DEPS += \
./08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/kiss_fft.d 

OBJS += \
./08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/kiss_fft.o 


# Each subdirectory must supply rules for building sources it contributes
08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/%.o 08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/%.su 08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/%.cyclo: ../08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/%.c 08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/subdir.mk
...
clean: clean-08-2d-DCMI2LCD-2f-Middlewares-2f-tensorflow-2f-third_party-2f-kissfft

clean-08-2d-DCMI2LCD-2f-Middlewares-2f-tensorflow-2f-third_party-2f-kissfft:
	-$(RM) ./08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/kiss_fft.cyclo ./08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/kiss_fft.d ./08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/kiss_fft.o ./08-DCMI2LCD/Middlewares/tensorflow/third_party/kissfft/kiss_fft.su

.PHONY: clean-08-2d-DCMI2LCD-2f-Middlewares-2f-tensorflow-2f-third_party-2f-kissfft
