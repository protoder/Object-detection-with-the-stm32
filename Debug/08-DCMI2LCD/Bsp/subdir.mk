...
C_SRCS += \
../08-DCMI2LCD/Bsp/board.c 

C_DEPS += \
./08-DCMI2LCD/Bsp/board.d 

OBJS += \
./08-DCMI2LCD/Bsp/board.o 


# Each subdirectory must supply rules for building sources it contributes
08-DCMI2LCD/Bsp/%.o 08-DCMI2LCD/Bsp/%.su 08-DCMI2LCD/Bsp/%.cyclo: ../08-DCMI2LCD/Bsp/%.c 08-DCMI2LCD/Bsp/subdir.mk
...
clean: clean-08-2d-DCMI2LCD-2f-Bsp

clean-08-2d-DCMI2LCD-2f-Bsp:
	-$(RM) ./08-DCMI2LCD/Bsp/board.cyclo ./08-DCMI2LCD/Bsp/board.d ./08-DCMI2LCD/Bsp/board.o ./08-DCMI2LCD/Bsp/board.su

.PHONY: clean-08-2d-DCMI2LCD-2f-Bsp
